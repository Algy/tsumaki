...
#ifndef PROTOBUF_ErrorResponse_2eproto__INCLUDED
#define PROTOBUF_ErrorResponse_2eproto__INCLUDED
...
class ErrorResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tsumaki.ErrorResponse) */ {
 public:
  ErrorResponse();
 ...
 private:
  ...
  friend void  protobuf_AddDesc_ErrorResponse_2eproto();
  friend void protobuf_AssignDesc_ErrorResponse_2eproto();
  friend void protobuf_ShutdownFile_ErrorResponse_2eproto();
...
#endif  // PROTOBUF_ErrorResponse_2eproto__INCLUDED
