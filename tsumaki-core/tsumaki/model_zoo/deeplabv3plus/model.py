...
class BilinearUpsampling(Layer):
    ...
    def call(self, inputs):
        ...
        from plaidml.keras.backend import resize_images
        ...
        if backend_name == 'tensorflow':
            ...
            if os.environ.get('PLAIDML_USE_NEAREST'):
                ...
                intp = 'bilinear'
            if self.upsampling:
                return resize_images(inputs, self.upsampling[0], self.upsampling[1], 'channels_last', intp)
            else:
...
def _inverted_res_block(inputs, expansion, stride, alpha, filters, block_id, skip_connection, rate=1):
    ...
    if pointwise_filters < 8:
        pointwise_filters = 8
    '''
    # orig_pointwise_filters = _make_divisible(filters, 8)
...
def Deeplabv3(weights='pascal_voc', input_tensor=None, input_shape=(512, 512, 3), classes=21, backbone='mobilenetv2', OS=16, alpha=1):
    ...
    if backbone == 'xception':
        ...
        x = _inverted_res_block(x, filters=12, alpha=alpha, stride=1,
